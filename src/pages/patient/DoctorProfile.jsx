...
export default function DoctorProfile() {
  ...
  if (loading) {
    return (
      <PatientLayout title="Loading Doctor Profile...">
  ...
  if (!doctor) {
    return (
      <PatientLayout title="Doctor Profile Not Found">
        <div className="p-8 flex flex-col items-center justify-center">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 text-center max-w-md shadow-xs">
            ...
            <Link
              to="/patient/doctors"
              className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-white bg-emerald-700 rounded-xl hover:bg-emerald-800 transition"
            >
  ...
  return (
    <PatientLayout
      title={doctor.name}
      breadcrumbs={[
        { label: 'Specialist Directory', link: '/patient/doctors' },
        { label: doctor.name },
      ]}
    >
      <div id="doctor-profile-content" className="p-4 sm:p-8 space-y-6 max-w-6xl mx-auto">
