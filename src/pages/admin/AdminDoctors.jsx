...
export default function AdminDoctors() {
  ...
  return (
    <AdminLayout
      title="Hospital Medical Staff Roster"
      breadcrumbs={[{ label: 'Doctor Management' }]}
    >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-xs">
          <div>
            <h2 className="text-sm font-bold text-slate-900">
              Registered Hospital Physicians & Specialists ({doctors.length})
            </h2>
            <p className="text-xs text-slate-500">
              Configure department appointments, OPD consultation fees, and weekly slot availability
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold text-white bg-emerald-700 hover:bg-emerald-800 rounded-xl transition shadow-xs cursor-pointer"
            >
